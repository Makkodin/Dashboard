...
@lru_cache(maxsize=8)
# Это функция для загрузки данных, связанных с блоком «загрузки css текста cached». 
...
# Это функция для загрузки данных, связанных с блоком «загрузки css folder». 
# Используется в следующих блоках: app.py.
# На вход: folder.
# На выход: None.
...
# Это функция для отрисовки блока «global loading overlay» в интерфейсе дашборда.
# Используется в следующих блоках: app.py.
...
# Это функция для блока «отрисовки clinical info раздела». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: app.py.
# На вход: функция не ожидает обязательных входных параметров.
# На выход: None.
