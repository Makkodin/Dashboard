...
# Это функция для блока «extract purity from filename cached». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: folder_str, folder_mtime_ns.
# На выход: float  или  None.
...
# Это функция для блока «extract purity from filename». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: folder.
# На выход: float  или  None.
...
# Это функция для блока «нормализации composition». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: items.
...
# Это функция для блока «match образца code cached». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
...
# Это функция для блока «match образца code». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: sample, source_path.
# На выход: str.
...
# Это функция для блока «catalog entry». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: catalog, code.
...
# Это функция для блока «infer subtype». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: catalog, tmb_value, purity_percent.
...
# Это функция для блока «compute total иммунного профиля percent». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: composition.
# На выход: float.
...
# Это функция для блока «compute cd8 treg ratio». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: composition.
# На выход: float.
...
# Это функция для блока «compute effector t cells». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: core/immune_status.py.
# На вход: composition.
# На выход: float.
...
# Это функция для формирования промежуточной структуры данных для блока «сборки иммунного профиля interpretation». 
# Используется в следующих блоках: core/immune_status.py.
# На вход: data.
# На выход: str.
...
# Это функция для загрузки данных, связанных с блоком «загрузки иммунного профиля иммунного статуса». 
# Используется в следующих блоках: sections/immune_status_block.py, core/recommendations.py.
# На вход: sample.
