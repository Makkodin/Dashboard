...
# Это функция для блока «иконки svg». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: sections/treatment_block.py.
# На вход: icon_type, color.
# На выход: str.
...
# Это функция для блока «resolve таймлайна иконки». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: sections/treatment_block.py.
# На вход: stage_name.
# На выход: str.
