...
# Это функция для блока «отрисовки пациента card html». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: sections/patient_block.py.
# На вход: rows.
# На выход: str.
...
# Это функция для отрисовки блока «пациента block» в интерфейсе дашборда.
