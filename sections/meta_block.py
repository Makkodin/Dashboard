...
# Это функция для блока «иммунного статуса badge html». Она нужна для того, чтобы вынести отдельный шаг логики в самостоятельную и читаемую часть кода.
# Используется в следующих блоках: sections/meta_block.py.
# На вход: status_value.
# На выход: str.
...
# Это функция для отрисовки блока «метаданных block» в интерфейсе дашборда.
...
def render_meta_block():
    ...
    if st.session_state["edit_meta"]:
        ...
        with st.form("meta_edit_form", clear_on_submit=False):
